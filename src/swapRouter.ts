...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@cytoswap/sdk-core'
...
import ISwapRouter from '@cytoswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the Cytoswap V3 SwapRouter, and has static methods for helping execute trades.
 */
