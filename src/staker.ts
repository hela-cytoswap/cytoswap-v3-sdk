import { BigintIsh, Token, validateAndParseAddress } from '@cytoswap/sdk-core'
import { MethodParameters, toHex } from './utils/calldata'
import { defaultAbiCoder, Interface } from '@ethersproject/abi'
import ICytoswapV3Staker from '@cytoswap/v3-staker/artifacts/contracts/CytoswapV3Staker.sol/CytoswapV3Staker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(ICytoswapV3Staker.abi)
